    ...
    $.widget("primeui.puidatatable", {
            ...
            if(this.data) {
                ...
                for(var i = first; i < (first + rows); i++) {
                    ...
                    if(rowData) {
                        ...
                        // PMC correction (END)
                        if(this.options.selectionMode && PUI.inArray(this.selection, /*i*/rowIndex)) { // PMC correction
        ...
        getSelection: function() {
            ...
            for(var i = 0; i < this.selection.length; i++) {
                if(this.data.length > this.selection[i]-first && 
                	this.selection[i]-first >= 0) /* VCS 09/02/2014: Se indica >= para que considere al seleccionar la primera fila */ {  
